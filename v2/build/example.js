var Overturn = React.createClass({displayName: "Overturn",
    ...
    createBoxH: function (width, height, index, count, angle, transition) {
        ...
        var a = React.createElement("div", {key: index, className: "Box", style: BoxStyle}, 
            React.createElement("div", {className: "Box01", style: Box01Style}), 
            React.createElement("div", {className: "Box02", style: Box02Style}), 
            React.createElement("div", {className: "Box03", style: Box03Style}), 
            React.createElement("div", {className: "Box04", style: Box04Style})
        );
        return a;
    },
    ...
    var MainBox01Style = {
        ...
        return (
            React.createElement("div", {ref: "overturn", className: "Overturn " + this.state.className, style: { width: width, height: height}, onClick: this.onClick}, 
                React.createElement("div", {className: "Space" + (this.state.mouseover?'':' hidden'), style: { width: width, height: height}}, 
                    box
                ), 
                React.createElement("div", {className: "MainBox01" + (this.state.mouseover?' hidden':''), style: MainBox01Style})
            )
        );
    }
});
...
ReactDOM.render(
    React.createElement(Overturn, {dir: "top", index: 0, duration: 1, difference: 0.1, count: 10, ImageData: ImageData}),
    document.getElementById('example01_0')
);
ReactDOM.render(
    React.createElement(Overturn, {dir: "right", index: 1, duration: 1, difference: 0.1, count: 10, ImageData: ImageData}),
    document.getElementById('example01_1')
);
ReactDOM.render(
    React.createElement(Overturn, {dir: "bottom", index: 2, duration: 1, difference: 0.1, count: 10, ImageData: ImageData}),
    document.getElementById('example01_2')
);
ReactDOM.render(
    React.createElement(Overturn, {dir: "left", index: 0, duration: 1, difference: 0.1, count: 10, ImageData: ImageData}),
    document.getElementById('example01_3')
);
ReactDOM.render(
    React.createElement(Overturn, {dir: "top", className: "Overturn02", reverse: true, index: 0, duration: 1, difference: 0.1, count: 10, ImageData: ImageData}),
